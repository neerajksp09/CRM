...
function Mandash() {
  ...
  //  const [followupcenter,setFollowupcenter]=([])


  const getmanager = async () => {
    const res = await axios.get(`http://localhost:5000/api/user/${localStorage.getItem('manager')}`)
    const res2 =await axios.get('http://localhost:5000/api/enq')
    const res3 =await axios.get('http://localhost:5000/api/followup')
    if (res.data.msg == "Success" && res2.data.msg=="Success" && res3.data.msg=="Success") {
      
    
      setMdata(res.data.user)
      setEnqdata(res2.data.enq)
      setFollowup(res3.data.followup)
    
      console.log("mdata", res.data.user)
      console.log("enqdata",res2.data.enq)
      console.log("Followup", res3.data.followup)
        ...
        <div className="col-sm-12">
              ...
              <div className='admin-welcome-left p-3'>
                <div className="row">
                  <div className="col-md-6">
                    <p>Welcome <strong>{mdata.name}</strong> </p>
                    <p>Overview</p>
          ...
          <div className="row">
                ...
                <div className="col-sm-12 col-md-6 col-lg-4 col-xl-3 p-2">
                  <Centercard heading={"hiir"} cirnum="0" cirper="(0%)" cir="0%" assi={"hioo"} follow={"hii"} enq={"hoi"} rec="No recent follow-ups" />
                </div>
