...
function Cenq() {
    ...
    const updateEnq = async (e) => {
        ...
        const assigndata = { enqid: editId, assignto: uid, assignby: localStorage.getItem('counselor'), assignbyModel: "user", remark: rem };
                                ...
                                <tbody className='enq-table-body'>
                                    {
                                        filteredenq.map((e, i) => (
                                            <tr key={i} onClick={() => handleRowClick(e)} style={{ cursor: "pointer" }}>
                                                ...
                                                <td>
                                                    <div className='bg-secondary rounded-5 text-light px-2 py-1  mt-1'>{e.source}</div>
                                                </td>
                                                <td>
                                                    <h4>{e.fullName}</h4>
                                                ...
                                                <td className={e.status=="u"?"text-success":"text-danger"}>
                                                    {e.status=="u"?"Active":"Deactive" || "New"}
                                                </td>
                                                <td>
                                                    {e.followupdate || "-"}
                                                </td>
                        ...
                        {selectedEnq && (
                            <>
                                ...
                                <div className="d-flex gap-2 mb-3">
                                    ...
                                    data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo" onClick={() => { assignfun(selectedEnq) }} >Transfer</button> */}
                                ...
                                <div className="position-relative">
                                     {
                                    d && <div style={{backgroundColor:"rgba(255,0,0,0.3)"}} className='d-flex h-100 w-100 justify-content-center align-items-center display-1 position-absolute rounded-3'>
